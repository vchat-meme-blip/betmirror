...
export class PolymarketAdapter {
    ...
    async initialize() {
        ...
        this.safeManager = new SafeManagerService(this.wallet, this.config.builderApiKey, this.config.builderApiSecret, this.config.builderApiPassphrase, this.logger, existingSafeAddress);
    ...
    initClobClient(apiCreds) {
        ...
        this.client = new ClobClient(HOST_URL, Chain.POLYGON, this.wallet, // Signer is EOA
        apiCreds, SignatureType.POLY_GNOSIS_SAFE, // Funder is Safe
    ...
    async createOrder(params, retryCount = 0) {
        ...
        try {
            ...
            const res = await this.client.createAndPostOrder(order, { negRisk }, OrderType.GTC);
            if (res && res.success) {
