                    ...
                    <div className="max-w-5xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-300 pb-10">
                        <div className="flex flex-col md:flex-row items-start md:items-center gap-4 mb-8 pb-8 border-b border-gray-200 dark:border-terminal-border">
                            <div className="flex items-center gap-4 w-full md:w-auto">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Trading Wallet Config</h2>
                            ...
                            <div className="w-full md:w-auto flex flex-col md:flex-row gap-3 md:items-center md:ml-auto">
                                <div className="flex flex-wrap gap-2">
                                    <div className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 text-[10px] text-gray-500 dark:text-gray-400 font-bold">Dedicated EOA</div>
                                    <div className="px-2 py-1 bg-gray-100 dark:bg-gray-800 rounded border border-gray-200 dark:border-gray-700 text-[10px] text-gray-500 dark:text-gray-400 font-bold">Non-Custodial</div>
                                ...
                                <div className="bg-white dark:bg-terminal-card border border-gray-200 dark:border-terminal-border rounded-xl p-5 space-y-4 shadow-sm dark:shadow-none">
                                    <div className="flex justify-between items-center">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <div>
                                                <div className="text-sm font-bold text-gray-900 dark:text-white">Trading Wallet</div>
                                                <div className="text-[10px] text-gray-500">EOA (Type 0 Sig)</div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex justify-between items-center pt-2">
                                        ...
                                        <button onClick={openWithdrawModal} className="px-3 py-1 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-500 text-xs font-bold rounded hover:bg-red-100 dark:hover:bg-red-900/40">Withdraw Funds</button>
                                    </div>
                                </div>
                                {/* API Keys */}
